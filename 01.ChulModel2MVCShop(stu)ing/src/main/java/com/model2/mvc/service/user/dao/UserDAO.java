...
public class UserDAO {
	...
	public UserVO findUser(String userId) throws Exception {
		...
		con.close();
		System.out.println("UserDAO.findUser aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
		return userVO;
	}
	public void insertUser(UserVO userVO) throws Exception {
		...
		con.close();
		System.out.println("UserDAO.insertUser bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb");
	}
	...
	public HashMap<String,Object> getUserList(SearchVO searchVO) throws Exception {
		...
		if (searchVO.getSearchCondition() != null) {
			if (searchVO.getSearchCondition().equals("0")) {
				sql += " where USER_ID LIKE'%" + searchVO.getSearchKeyword()
						+ "%'";
				System.out.println("여기에요 여기 LIKE 잘됨, 여기에요 여기 회원ID LIKE 잘됨");
			} else if (searchVO.getSearchCondition().equals("1")) {
				sql += " where USER_NAME LIKE'%" + searchVO.getSearchKeyword()
						+ "%'";
				System.out.println("여기에요 여기 LIKE 잘됨, 여기에요 여기 회원명 LIKE 잘됨");
			}
		}
		...
		con.close();
		System.out.println("UserDAO.getUserList cccccccccccccccccccccccccccccccccccccccccc");	
		return map;
	}
	...
	public void updateUser(UserVO userVO) throws Exception {
		...
		con.close();
		System.out.println("UserDAO.updateUser ddddddddddddddddddddddddddddddddddddddddddd");
	}
}